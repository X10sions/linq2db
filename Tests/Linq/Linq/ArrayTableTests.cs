...
namespace Tests.Linq
{
	...
	public class ArrayTableTests : TestBase
	{
		...
		[Test]
		public void InnerJoinArray([DataSources(TestProvName.AllAccess, ProviderName.DB2, ProviderName.DB2iSeries, TestProvName.AllInformix)] string context)
		{
			var doe = "Doe";
			using (var db = GetDataContext(context))
			{
		...
		[Test]
		public void InnerJoinArray2([DataSources(TestProvName.AllAccess, ProviderName.DB2, ProviderName.DB2iSeries, TestProvName.AllInformix)] string context)
		{
			var doe = "Doe";
			using (var db = GetDataContext(context))
			{
		...
		[Test]
		public void InnerJoinArray3([DataSources(TestProvName.AllAccess, ProviderName.DB2, ProviderName.DB2iSeries, TestProvName.AllInformix)] string context)
		{
			var doe = "Doe";
		...
		[Test]
		public void InnerJoinArray4([DataSources(TestProvName.AllAccess, ProviderName.DB2, ProviderName.DB2iSeries, TestProvName.AllInformix)] string context)
		{
			var doe = "Doe";
		...
		[Test]
		public void InnerJoinArray5([DataSources(TestProvName.AllAccess, ProviderName.DB2, ProviderName.DB2iSeries, TestProvName.AllInformix)] string context)
		{
			var doe = "Doe";
		...
		[Test]
		public void InnerJoinClassArray([DataSources(TestProvName.AllAccess, ProviderName.DB2, ProviderName.DB2iSeries, TestProvName.AllInformix)] string context)
		{
			using (var db = GetDataContext(context))
			{
				var q =
