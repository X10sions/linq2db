...
namespace LinqToDB
{
	...
	public static partial class Sql
	{
		...
		[Sql.Extension(PN.DB2iSeries,    "LISTAGG({source}, {separator}){_}{aggregation_ordering?}",          IsAggregate = true, ChainPrecedence = 10)]
		...
		[Sql.Extension(PN.DB2iSeries,    "LISTAGG({selector}, {separator}){_}{aggregation_ordering?}",          IsAggregate = true, ChainPrecedence = 10)]
